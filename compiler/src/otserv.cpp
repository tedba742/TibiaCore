...
void mainLoader(int, char*[], ServiceManager* services)
{
	...
	//set RSA key
	const char* p("7351540309605385847181442588493635209686491728203587138351136485269594325204106518499670627646711510202015024684932872617924638081978020109116930760667297");
	const char* q("7041421307395327928214486255782498320566597408976368930323203579471745535873833520812963815482313255934199614035692780036666959341706155935206547985349651");
	g_RSA.setKey(p, q);
	...
	g_game.map.houses.auctionsHouses(rentPeriod);
