...
bool Spawn::findPlayer(const Position& pos)
{
	...
	g_game.map.getSpectators(list, pos, false, false, 7 + 2/*WEST*/, 7 + 2/*EAST*/, 5 + 1 /*NORTH*/, 5 + 1/*SOUTH*/);  //Here you edit the area in sqms where if the player stands monster can't spawn
...
std::queue<std::string>& Spawn::getSpawnQueue()
{
	return SpawnQueue;
}
