...
local function revertBridge()
	Tile(bridgePosition):getItemById(1771):transform(622)
end
...
function onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	if not Tile(Position(32795, 32337, 11)):getItemById(2886, 7) then
	...
	if water then
		water:transform(1771)
		addEvent(revertBridge, 180 * 60 * 1000)
	end
