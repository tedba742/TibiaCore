function onUse(player, item, fromPosition, target, toPosition)
	if item:getId() == 2773 and Game.isItemThere({x = 32594, y = 32214, z = 09},3050) then 
		...
		--Game.createItem(3050, 1,{x = 32594, y = 32214, z = 09})
	elseif item:getId() == 2773 then 
		Game.sendMagicEffect({x = 32594, y = 32214, z = 09}, 3)
	elseif item:getId() == 2772 and Game.isItemThere({x = 32594, y = 32214, z = 09},3050) then
		...
		Game.removeItemOnMap({x = 32594, y = 32214, z = 09}, 3050)
		Game.sendMagicEffect({x = 32594, y = 32214, z = 09}, 9)
		Game.createItem(3050, 1,{x = 32613, y = 32220, z = 10})
